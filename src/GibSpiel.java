...
public class GibSpiel {
    ...
    public static void main(String[] args) {
        ...
        while (ablauf) {
            ...
            System.out.println("2. Spieler vs. PC");
    ...
    private static void spielBeginnen(Spieler spieler1, Spieler spieler2) {
        ...
        while (true) {
            ...
            zugUndAbfrage(spieler1, spielbrett);
            if (gewonnen(spieler1, spielbrett)) break;
            ausgabeSteineAktuell(spielbrett);
            zugUndAbfrage(spieler2, spielbrett);
    ...
    private static void zugUndAbfrage(Spieler spieler, Spielbrett spielbrett) {
        int anzahlSteine;
        do {
